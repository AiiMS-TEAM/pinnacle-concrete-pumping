<?php
/**
 * Pinnacle quote form handler — runs on
 * api.pinnacleconcretepumping.com.au (cPanel).
 *
 * Connected to: <form id="quoteForm"> (#quote section) on index.html.
 *
 ...
 *   name, phone, email, location, pump, service, details, recaptcha_token
 */
...
if (!in_array($pump, $allowedPump, true))         $errors[] = 'pump';
if (!in_array($service, $allowedService, true))   $errors[] = 'service';
...
$detailsForMail = $details !== '' ? $details : 'Not provided';
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:560px; margin:0 auto; background:#ffffff; border-radius:8px; overflow:hidden; border:1px solid #e5e5ec;">
    <tr>
      <td style="padding:20px 24px; background:#0A0A14; color:#ffffff;">
        ...
        <h2 style="margin:6px 0 0; font-size:20px; font-weight:700;">New Quote Request</h2>
      </td>
    </tr>
    <tr>
      <td style="padding:20px 24px;">
        <p style="margin:0 0 16px; font-size:14px;">A new quote request was submitted via the Pinnacle website. Reach out ASAP to lock in the booking.</p>
        <table cellpadding="10" cellspacing="0" border="0" width="100%" style="border-collapse:collapse; font-size:14px;">
          ...
          <tr><td style="background:#f5f5f7; border:1px solid #e5e5ec;"><strong>Job location</strong></td><td style="border:1px solid #e5e5ec;">' . $h($location) . '</td></tr>
          <tr><td style="background:#f5f5f7; border:1px solid #e5e5ec;"><strong>Pump type</strong></td><td style="border:1px solid #e5e5ec;">' . $h($pump) . '</td></tr>
          <tr><td style="background:#f5f5f7; border:1px solid #e5e5ec;"><strong>Service type</strong></td><td style="border:1px solid #e5e5ec;">' . $h($service) . '</td></tr>
          <tr><td style="background:#f5f5f7; border:1px solid #e5e5ec;"><strong>Project details</strong></td><td style="border:1px solid #e5e5ec;">' . nl2br($h($detailsForMail)) . '</td></tr>
        </table>
      </td>
    </tr>
    <tr>
      <td style="padding:16px 24px; background:#f5f5f7; font-size:12px; color:#666666;">
        Sent from the Pinnacle Concrete Pumping website quote form.
      </td>
    </tr>
  </table>
</body>
...
$clientSubject = 'Thanks for your quote request — Pinnacle Concrete Pumping';
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:560px; margin:0 auto; background:#ffffff; border-radius:10px; overflow:hidden; border:1px solid #e5e5ec;">
    <tr>
      <td style="padding:28px 24px; background:linear-gradient(135deg,#CA065E 0%,#0A0A14 100%); color:#ffffff; text-align:center;">
        ...
        <p style="margin:6px 0 0; font-size:14px; opacity:.95;">We&rsquo;ve received your quote request.</p>
      </td>
    </tr>
    <tr>
      <td style="padding:22px 24px;">
        <p style="margin:0 0 14px; font-size:14px;">A member of our team will be in touch shortly to confirm your booking details and get your pump locked in. If your job is urgent, please call us on <a href="tel:1300688390" style="color:#CA065E; font-weight:700; text-decoration:none;">1300 688 390</a>.</p>
        ...
        <table cellpadding="10" cellspacing="0" border="0" width="100%" style="border-collapse:collapse; font-size:14px;">
          ...
          <tr><td style="background:#fafafb; border:1px solid #eceef1;"><strong>Job location</strong></td><td style="border:1px solid #eceef1;">' . $h($location) . '</td></tr>
          <tr><td style="background:#fafafb; border:1px solid #eceef1;"><strong>Pump type</strong></td><td style="border:1px solid #eceef1;">' . $h($pump) . '</td></tr>
          <tr><td style="background:#fafafb; border:1px solid #eceef1;"><strong>Service type</strong></td><td style="border:1px solid #eceef1;">' . $h($service) . '</td></tr>
          <tr><td style="background:#fafafb; border:1px solid #eceef1;"><strong>Project details</strong></td><td style="border:1px solid #eceef1;">' . nl2br($h($detailsForMail)) . '</td></tr>
        </table>
      </td>
    </tr>
    <tr>
...
respond(true, 'Thanks ' . $firstName . ' — we have received your request and will be in touch shortly.');
